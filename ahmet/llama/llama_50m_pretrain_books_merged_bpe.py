...
filepath = hf_hub_download(
    ...
    filename="books_merged_bpe_tokens.safetensors",
    repo_type="dataset"
)
...
save_interval = 20*60 # 2 hours in seconds
    ...
    for X, Y in tqdm(train_dataloader):
        ...
        if time.time() - last_save_time >= save_interval:
            ...
            upload_file(
                ...
                repo_id="AhmetSemih/llama-50m-pretrained-books-merged_bpe",
                path_in_repo="llama-50m-pretrained-books-merged_bpe.safetensors",
